...
// TEST_F(SwerveDriveControllerTest, check_exported_intefaces)
// {
//   SetUpController();
...
// TEST_F(SwerveDriveControllerTest, test_setting_slow_mode_service)
// {
//   SetUpController();
...
// TEST_F(SwerveDriveControllerTest, test_update_logic_fast)
// {
//   SetUpController();
//   rclcpp::executors::MultiThreadedExecutor executor;
//   executor.add_node(controller_->get_node()->get_node_base_interface());
...
// TEST_F(SwerveDriveControllerTest, test_update_logic_slow)
// {
//   SetUpController();
//   rclcpp::executors::MultiThreadedExecutor executor;
//   executor.add_node(controller_->get_node()->get_node_base_interface());
...
// TEST_F(SwerveDriveControllerTest, publish_status_success)
// {
//   SetUpController();
