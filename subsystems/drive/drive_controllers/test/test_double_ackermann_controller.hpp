...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_DOUBLE_ACKERMANN_CONTROLLER_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_DOUBLE_ACKERMANN_CONTROLLER_HPP_
...
class TestableDoubleAckermannController : public athena_drive_controllers::DoubleAckermannController
{
  ...
  FRIEND_TEST(DoubleAckermannControllerTest, reactivate_success);
  FRIEND_TEST(DoubleAckermannControllerTest, test_setting_slow_mode_service);
  FRIEND_TEST(DoubleAckermannControllerTest, test_update_logic_fast);
  FRIEND_TEST(DoubleAckermannControllerTest, test_update_logic_slow);
...
class DoubleAckermannControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_double_ackermann_controller/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_double_ackermann_controller/set_slow_control_mode");
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_double_ackermann_controller")
  {
    ASSERT_EQ(
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_double_ackermann_controller/state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestableDoubleAckermannController> controller_;
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_DOUBLE_ACKERMANN_CONTROLLER_HPP_
