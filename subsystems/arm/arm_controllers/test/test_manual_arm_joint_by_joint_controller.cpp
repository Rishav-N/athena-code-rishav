...
TEST_F(ManualArmJointByJointControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(ManualArmJointByJointControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(ManualArmJointByJointControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(ManualArmJointByJointControllerTest, update_success)
{
  SetUpController();
...
TEST_F(ManualArmJointByJointControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(ManualArmJointByJointControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(ManualArmJointByJointControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(ManualArmJointByJointControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(ManualArmJointByJointControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(ManualArmJointByJointControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(ManualArmJointByJointControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
