...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_manual_arm_joint_by_joint_CONTROLLER_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_manual_arm_joint_by_joint_CONTROLLER_HPP_
...
using ControllerStateMsg = athena_arm_controllers::ManualArmJointByJointController::ControllerStateMsg;
using ControllerReferenceMsg = athena_arm_controllers::ManualArmJointByJointController::ControllerReferenceMsg;
using ControllerModeSrvType = athena_arm_controllers::ManualArmJointByJointController::ControllerModeSrvType;
...
class TestableManualArmJointByJointController : public athena_arm_controllers::ManualArmJointByJointController
{
  ...
  FRIEND_TEST(ManualArmJointByJointControllerTest, reactivate_success);
  FRIEND_TEST(ManualArmJointByJointControllerTest, test_setting_slow_mode_service);
  FRIEND_TEST(ManualArmJointByJointControllerTest, test_update_logic_fast);
  FRIEND_TEST(ManualArmJointByJointControllerTest, test_update_logic_slow);

public:
  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = athena_arm_controllers::ManualArmJointByJointController::on_configure(previous_state);
...
class ManualArmJointByJointControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_manual_arm_joint_by_joint_controller/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_manual_arm_joint_by_joint_controller/set_slow_control_mode");
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_manual_arm_joint_by_joint_controller")
  {
    ASSERT_EQ(
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_manual_arm_joint_by_joint_controller/state", 10, subs_callback);
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_manual_arm_joint_by_joint_CONTROLLER_HPP_
