...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_manual_arm_cylindrical_controller_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_manual_arm_cylindrical_controller_HPP_
...
class TestableManualArmCylindricalController : public athena_arm_controllers::ManualArmCylindricalController
{
  ...
  FRIEND_TEST(ManualArmCylindricalControllerTest, reactivate_success);
  FRIEND_TEST(ManualArmCylindricalControllerTest, test_setting_slow_mode_service);
  FRIEND_TEST(ManualArmCylindricalControllerTest, test_update_logic_fast);
  FRIEND_TEST(ManualArmCylindricalControllerTest, test_update_logic_slow);
...
class ManualArmCylindricalControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_manual_arm_cylindrical_controller/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_manual_arm_cylindrical_controller/set_slow_control_mode");
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_manual_arm_cylindrical_controller")
  {
    ASSERT_EQ(
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_manual_arm_cylindrical_controller/state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestableManualArmCylindricalController> controller_;
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_manual_arm_cylindrical_controller_HPP_
