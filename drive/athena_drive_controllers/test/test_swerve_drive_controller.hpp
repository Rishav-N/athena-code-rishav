...
// #ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_SWERVE_DRIVE_CONTROLLER_HPP_
// #define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_SWERVE_DRIVE_CONTROLLER_HPP_
...
//   FRIEND_TEST(SwerveDriveControllerTest, test_setting_slow_mode_service);
//   FRIEND_TEST(SwerveDriveControllerTest, test_update_logic_fast);
//   FRIEND_TEST(SwerveDriveControllerTest, test_update_logic_slow);
...
//       "/test_swerve_drive_controller/commands", rclcpp::SystemDefaultsQoS());
...
//       "/test_swerve_drive_controller/set_slow_control_mode");
//   }
...
//       "/test_swerve_drive_controller/state", 10, subs_callback);
...
// #endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_SWERVE_DRIVE_CONTROLLER_HPP_
