...
#include "test_double_ackermann_controller.hpp"
...
TEST_F(DoubleAckermannControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(DoubleAckermannControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(DoubleAckermannControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(DoubleAckermannControllerTest, update_success)
{
  SetUpController();
...
TEST_F(DoubleAckermannControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(DoubleAckermannControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(DoubleAckermannControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(DoubleAckermannControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(DoubleAckermannControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(DoubleAckermannControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(DoubleAckermannControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
