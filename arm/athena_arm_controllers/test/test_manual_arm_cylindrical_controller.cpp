...
#include "test_manual_arm_cylindrical_controller.hpp"
...
class ManualArmCylindricalControllerTest : public ManualArmCylindricalControllerFixture<TestableManualArmCylindricalController>
{
};

TEST_F(ManualArmCylindricalControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(ManualArmCylindricalControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(ManualArmCylindricalControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(ManualArmCylindricalControllerTest, update_success)
{
  SetUpController();
...
TEST_F(ManualArmCylindricalControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(ManualArmCylindricalControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(ManualArmCylindricalControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(ManualArmCylindricalControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(ManualArmCylindricalControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(ManualArmCylindricalControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(ManualArmCylindricalControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
